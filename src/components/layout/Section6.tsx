  ...
  return (
    <section className="mx-auto min-h-screen">
      ...
      <div className="-mt-[34%] text-center">
        <h3 className="section-6-heading overflow-hidden whitespace-nowrap font-sans text-[16vw] font-[700] tracking-normal text-gray-50/20">
      ...
      <div className="mx-auto mt-10 max-w-[1280px] px-12">
        <div className="mb-8 text-[1.875rem] font-[600] text-gray-50">
        ...
        <div className="relative">
          ...
          <div className="absolute right-[100px] top-[calc(100%*873.91/1043.82)] text-[1.5vw] font-[600] text-green3">
            An ninh thông minh
          </div>
        </div>
