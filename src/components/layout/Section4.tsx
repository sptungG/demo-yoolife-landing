      ...
      <div className="relative">
        <div className="mx-auto flex max-w-[1280px] flex-col items-center px-12 py-6 xl:flex-row xl:items-stretch">
          <div className="min-w-0 flex-[1_1_auto] text-gray-100 xl:mr-[26px]">
            <div className="mb-[64px] text-justify text-[1.25rem] font-[300] leading-[2]">
            ...
            <div className="text-justify text-[1.25rem] font-[300] leading-[2]">
          ...
          <div className="mt-6 min-w-0 xl:mt-0 xl:flex-[0_0_480px]">
            <Image
              width={480}
              height={376}
              src="/v1/section-4-lotte.png"
              alt="section-4-lotte"
              className="mb-1 rounded-tl-[125px]"
            />
            <div className="mb-1 text-center text-base text-gray-100">
              Lotte Mall Westlake, Võ Chí Công – Tây Hồ
            </div>
            <Image
              width={480}
              height={376}
              src="/v1/section-4-lotte-2.png"
